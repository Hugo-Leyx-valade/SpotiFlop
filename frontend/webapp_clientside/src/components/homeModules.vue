...
<template>
    <div class="home" onload="changeBodyBackgroundColor()">
        <header>
            ...
            <span style="font-family: 'LilGrotesk-bold'; font-size: 100px; color: white; position: fixed; top: -3%; left: 39.5%;" >SpotiFlop</span>
        </header>
        <section id="slider">
...
#s5:checked ~ #slide3 {
    ...
    transform: translate3d(-70%,10%,-450px);
}
...
#s5:checked ~ #slide4 {
    ...
    transform: translate3d(-30%,10%,-150px);
}
