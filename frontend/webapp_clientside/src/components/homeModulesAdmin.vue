...
<template>
    <div class="home" onload="changeBodyBackgroundColor()">
        <header>
            <a href="/#/home"><img id="icon" src="../assets/spotify-playlist_white.png" alt="logo_white" ></a>
            <span style="font-family: 'LilGrotesk-bold'; font-size: 100px; color: white; position: fixed; top: -1.3%; left: 39.5%;" >SpotiFlop</span>
        </header>
        <section id="slider">
            ...
            <label for="s1" id="slide1">
                <svg xmlns="http://www.w3.org/2000/svg" width="300" height="300" fill="white" class="bi bi-save-fill" viewBox="0 0 16 16" style="margin-top:25% ;">
            ...
            <label for="s2" id="slide2">
                <svg xmlns="http://www.w3.org/2000/svg" width="300" height="300" fill="white" class="bi bi-save-fill" viewBox="0 0 16 16" style="margin-top:30% ;">
...
export default {
    ...
    changeBodyBackgroundColor() {
        document.body.style.background = 'linear-gradient(180deg, rgba(28,200,89,1) 0%, rgba(0,0,0,1) 45%) no-repeat';
